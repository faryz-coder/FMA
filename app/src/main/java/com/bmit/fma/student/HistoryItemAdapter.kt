...
class HistoryItemAdapter(private val listHistory: MutableList<ListOrder>, val onClickInterface: InterfaceListener) : RecyclerView.Adapter<HistoryItemAdapter.ViewHolder>(), ItemCallback {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_history_row, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val listOrder = Gson().fromJson(history.order, Array<ListMenu>::class.java)
        val orderSummaryAdapter = OrderSummaryAdapter(listOrder, holder.itemView.context)
